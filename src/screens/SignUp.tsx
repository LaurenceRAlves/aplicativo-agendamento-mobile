...
//utilizado para armazenar as informacoes da aplicacao (storage = memoria do celular) simula um bando de dados
...
//yup para validacao dos formularios
...
export function SignUp() {
  //@react-navigation/native usado para navegacao das telas da aplicacao 
  const { navigate } = useNavigation<AuthNavigatorRoutesProps>();
  
  //native-base biblioteca de componentes utilziado, https://docs.nativebase.io
  const toast = useToast();

  //react hook form usado para gerencimento do formulario
  const {
    control,
    formState: { errors },
    handleSubmit,
